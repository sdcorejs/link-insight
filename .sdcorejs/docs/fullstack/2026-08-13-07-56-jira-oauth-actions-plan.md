...
plan_context:
  ...
  approved_plan_path: .sdcorejs/plans/fullstack/2026-08-13-09-49-jira-oauth-actions.md
  ...
  parallel_candidates:
    ...
    frozen_contract:
      ...
      revision: 1
      derived_from_approved_plan_hash: sha256:v1:21a52a873a587b488c0b031b128137dd0295ef4772719684b0272a0e1712a345
      supersedes: null
    units: []
    shared_files:
...
artifact_context:
  ...
  source_plan: .sdcorejs/plans/fullstack/2026-08-13-09-49-jira-oauth-actions.md
  required_with_change:
    ...
    - path: .sdcorejs/plans/fullstack/2026-08-13-09-49-jira-oauth-actions.md
      kind: plan
      reason: Immutable approved execution contract.
  shared_owned: []
  conditional: []
  local_only:
    - path: .output/**
